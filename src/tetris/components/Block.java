...
public class Block {
	...
	private boolean isMoving; //As long as this is set to true, the block will be able to move

	/**
	 * Crates a new block. By default, the <code>isMoving</code> and <code>rotation</code>
	 * variables are <code>true</code> and <code>0</code>.
	 */
	public Block() {
		rotation = 0;
		isMoving = true;
	...
	/**
	 * Rotates the block counter clockwise. Only implemented in subclasses of block.
	 */
	...
	/**
	 * Set's the x and y coordinates of the block. Only implemented in subclasses of block.
	 */
	...
	/**
	 * Takes an ArrayList of squares and sets this as the square list of the block
	...
	/**
	 * Moves the block down. The distance moved will be equal
	 * to the <code>speed</code> of the block.
	 */
	...
	/**
	 * Moves the block right. The distance moved will be equal
	 * to the <code>speed</code> of the block.
	 */
	 ...
	 * @param dist The distance the block is to be moved right
	 */
	...
	/**
	 * Moves the block left. The distance moved will be equal
	 * to the <code>speed</code> of the block.
	 */
	 ...
	 * @param dist The distance the block is to be moved left
	 */
	 ...
	 * @param dist The distance the block is to be moved down
	 */
	...
	/**
	 * For each square in the block, check if it can move left without exiting the grid.
	...
	/**
	 * For each square in the block, check if it can move right without exiting the grid.
	...
	/**
	 * For each square in the block, check if it can move up without exiting the grid.
	...
	/**
	 * For each square in the block, check if it can move up without exiting the grid.
	 * If the block will be exiting the grid with it's next move, the block is halted
	 * and moved down to the edge of the grid.
